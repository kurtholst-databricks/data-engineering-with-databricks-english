...
MERGE INTO database_name.purchase_dates
USING database_name.purchases
ON purchase_dates.id = purchases.id
WHEN NOT MATCHED THEN
  INSERT (id, transaction_timestamp, price)
  VALUES (purchases.id, purchases.transaction_timestamp, purchases.price)
