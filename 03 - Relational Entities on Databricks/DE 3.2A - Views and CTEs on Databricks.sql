...
CREATE GLOBAL TEMPORARY VIEW global_temp_view_dist_gt_2000 
AS SELECT * FROM external_table WHERE distance > 2000;

SELECT * FROM global_temp.global_temp_view_dist_gt_2000;
